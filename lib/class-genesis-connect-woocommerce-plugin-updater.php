<?php
/**
 * The Genesis_Connect_Woocommerce_Plugin_Updater class which can be used to pull plugin updates from a new location.
 *
 ...
 * The Genesis_Connect_Woocommerce_Plugin_Updater class which can be used to pull plugin updates from a new location.
 */
class Genesis_Connect_Woocommerce_Plugin_Updater {
	/**
